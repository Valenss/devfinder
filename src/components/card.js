  ...
  return (
    <div className={styles.card_container}>
      <div className={styles.card}>
         <div className={styles.card_header_img_container_desktop}>
            <img src={userNew.avatar_url} />
          </div>
          <div className={styles.card_container_destkop}>
        {/* Card header */}
        <div className={styles.card_header}>
          <div className={styles.card_header_img_container_mobile}>
            <img src={userNew.avatar_url} />
          </div>
          <div className={styles.card_header_info_container}>
              ...
              <div><p className={styles.card_date}>
                Joined {dayjs(userNew.created_at).format("DD  MMM YYYY")}
              </p></div>
          </div>
        </div>
        ...
        <div className={styles.card_bio}>
          {userNew.bio ? <p>{userNew.bio}</p> : <h4 style={{ color: "var(--clr-unavailable)" }}>This user has no bio</h4>}
        </div>
        ...
        <div className={styles.info_container}>
          <div>
            <div>
              {userNew.location ? (
                ...
                <svg
                  height="20"
                  width="14"
                  style={{ fill: "var(--clr-unavailable)" }}
              ...
              {userNew.location ? (
                ...
                <h4 style={{ color: "var(--clr-unavailable)" }}>
                  Not available
                </h4>
              )}
            </div>
            <div>
              ...
              {userNew.html_url ? (
                <a href={userNew.html_url} className={styles.card_info_2nd_col}>
                  {userNew.html_url}
                </a>
              ) : (
                <h4 style={{ color: "var(--clr-unavailable)" }}>
          ...
          <div>
            ...
            <div>
              ...
              {userNew.organizations_url ? (
                <a
                  href={userNew.organizations_url}
                  className={styles.card_info_2nd_col}
                >
                  {userNew.organizations_url}
                </a>
              ) : (
