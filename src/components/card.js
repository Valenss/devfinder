            ...
            <div className={styles.card}>
                ...
                <div className={styles.card_header}>
                    ...
                    <div className={styles.card_header_info_container}>
                        ...
                        <h4 className={styles.card_user_name}>{userNew.name}</h4>
                        <p className={styles.card_header_user}>@{userNew.login}</p>
                        <p className={styles.card_date}>Joined {dayjs(userNew.created_at).format('DD  MMM YYYY')}</p>
                    </div>   
                </div>

                {/* Card description */}
                <div className={styles.card_bio}>
                    { userNew.bio ? <p>{userNew.bio}</p> : <h4>Not available</h4>}
                </div>
                ...
                <div className={styles.card_stats_container}>
                    <div>
                        <p>Repos</p>
                        <h4 className={styles.card_stats_number}>{userNew.public_repos}</h4>
                    </div>
                    <div>
                        <p>Followers</p>
                        <h4 className={styles.card_stats_number}>{userNew.followers}</h4>
                    </div>
                    <div>
                        <p>Following</p>
                        <h4 className={styles.card_stats_number}>{userNew.following}</h4>
                    </div>
                </div>
                ...
                <div className={styles.info_container}>
                    <div>
                        <div>
                            ...
                            {userNew.location ? <h4>{userNew.location}</h4> : <h4 style={{color: 'var(--clr-unavailable)'}}>Not available</h4> }
                        </div>
                        <div>
                            ...
                            {userNew.html_url ? <a href={userNew.html_url}>{userNew.html_url}</a> : <h4 style={{color: 'var(--clr-unavailable)'}}>Not available</h4>}
                        </div>
                    </div>
                    <div>
                    <div>
                            ...
                            { userNew.twitter_username ? <h4>{userNew.twitter_username}</h4> : <h4 style={{color: 'var(--clr-unavailable)'}}>Not available</h4>}
                        </div>
                        <div>
                            ...
                            {userNew.organizations_url ? <a href={userNew.organizations_url}>{userNew.organizations_url}</a> : <h4>Not available</h4>}
                        </div>
                    </div>
                </div>
